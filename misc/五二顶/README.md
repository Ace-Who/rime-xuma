...
- 二码首选，若省略空格，且后接二码词，且已达句末或标点，共两词四码，不足五码，则须输入后词的上屏码，同时会顶前词上屏。

总之，仅三码以上需加空格或用标点顶屏；对于首选词，一码和二码都是二键（一码首选
必加上屏码），除非已达句末或标点；句末或标点前一词若为二码首选，则需加上屏码。
即对于首选词，五二顶将三键词变成二键词，正如五四顶（常规方案）将五键词变成四键
词。
...
一码、二码的首选总是可以用 `[` 上屏的，而空格上屏只能用在单独打的时候（即不是紧
接在待顶屏的二码之后），所以可以考虑在初期一律用 `[` 上屏，以简化思维，即如下打
法：
